  ...
  return (
    <div className={`${CLASS_NAME}`}>
      <div className={`${CLASS_NAME}--item`}>
        ...
        <Select id='demo-simple-select' value={difficulty} onChange={difficultyHandler}>
      ...
      <div className={`${CLASS_NAME}--item`}>
        ...
        <Select id='demo-simple-select' value={boardSizes} onChange={sizeHandler}>
      ...
      <div className={`${CLASS_NAME}--item`}>
        ...
        <div className='switch' onClick={fullscreenSwitchHandler}>
          <label>
            Off
            <input type='checkbox' checked={isFullScreen} onChange={fullscreenSwitchHandler} />

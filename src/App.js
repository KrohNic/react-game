    ...
    <BrowserRouter>
      ...
      <footer className='page-footer blue accent-1'>
        <div className='container'>
          <a className='grey-text text-lighten-4' href='https://github.com/KrohNic'>
            Kroh Nickolay
          </a>
          2021
          <a className='grey-text text-lighten-4' href='https://rs.school/js/'>
            <img src='https://rs.school/images/rs_school_js.svg' alt='rs school logo' className='rss_logo' />
          </a>
        </div>
      </footer>
      <Storage />
